...
float BME280_readTemperature(void)
{
    ...
    uint32_t adc_T = BME280_read24(BME280_REGISTER_TEMPDATA);
        
    adc_T >>= 4;
    
    var1  = ((((adc_T>>3) - ((uint32_t)cal_data.dig_T1 <<1))) *
             
             ((uint32_t)cal_data.dig_T2)) >> 11;
    
    var2  = (((((adc_T>>4) - ((uint32_t)cal_data.dig_T1)) *
               
               ((adc_T>>4) - ((uint32_t)cal_data.dig_T1))) >> 12) *
             
             ((uint32_t)cal_data.dig_T3)) >> 14;
